...
import type { MFControlCustomerProductOption, MFControlCustomerRecord } from '@/lib/mf-control/customers'
...
export function ClientesPageClient({ customers, products }: ClientesPageClientProps) {
  const [search, setSearch] = useState('')
  const [selectedProduct, setSelectedProduct] = useState<string | null>(null)
  const [selectedStatus, setSelectedStatus] = useState<string | null>(null)
  const [selectedClient, setSelectedClient] = useState<MFControlCustomerRecord | null>(null)
            ...
            {filteredClients.length > 0 ? (
              filteredClients.map((client) => (
                ...
                >
                  ...
                  <TableCell>
                    <Badge className={getStatusConfig(client.status).color}>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge className={cn('mt-1', getStatusConfig(selectedClient.status).color)}>
