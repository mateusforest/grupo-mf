...
export default function MonitoramentoPage() {
  const allOnline = systemStatus.every((s) =>
    Object.values(s).every((v) => v === 'online' || typeof v === 'string' && v === s.name)
  )
    ...
    <div className="space-y-6">
      ...
      <div
        className={cn(
          ...
          allOnline ? 'border-success/30 bg-success/10' : 'border-warning/30 bg-warning/10'
        )}
      >
        {allOnline ? (
          <>
                ...
                {Array.from({ length: 30 }).map((_, i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      i === 12 || i === 23 ? 'bg-warning/60' : 'bg-success/60'
                    )}
                  />
                ))}
              </div>
